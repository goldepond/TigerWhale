                        ...
                        <div class="GigDetailContainer">
                            ...
                            <div class="LeftModules">
                                ...
                                <div class="GigMainGallery">
                                    <div class="LazyLoad">
                                        <img src="/publishing/TestWeb/resources/img/detailPageImg/logo.jpg">
                                    </div>
                                </div>
                                ...
                                <div class="reply-group">
                                    <div class="reply-input">
                                        <input type="text" class="form-control" placeholder="이름" name="replyID"
                                            id="replyID"> <input type="password" class="form-control" placeholder="비밀번호"
                                            name="replyPW" id="replyPW">
                                    </div>
