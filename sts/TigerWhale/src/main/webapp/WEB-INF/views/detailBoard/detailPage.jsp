							...
							<div class="GigDetailContainer">
								...
								<div class="LeftModules">
									<div class="GigBreadcrumb">
										<!-- 카테고라ㅣ-->
										<a href="###"
											class="vgig-site-map">${categoryBoardVO.bigCategory}</a><span>></span> <a
											href="###"
											class="vgig-site-map">${categoryBoardVO.middleCategory}</a><span>></span> <a
											href="###" class="vgig-site-map">${categoryBoardVO.smallCategory}</a>
									</div>
									...
									<div class="GigMainGallery">
										<div class="LazyLoad">
											<c:forEach var="vo" items="${IMGBoardVO}">
												<tr>
													<td><img src="../resources/img/detailPageImg/${vo.img}.jpg"></td>
												</tr>
                                ...
                                <div class="GigNavigator">
                                    <div class="gig-navigation-box menuBtn">
                                            <button class="share-btn btn-xss btn dropdown-toggle gig-navigation active sidenav"
                                                id="gig-navigation-title_A"> 설명1</button>

                                            <button class="share-btn  btn dropdown-toggle gig-navigation active"
                                                id="gig-navigation-title_B"> 설명12</button>

 <!--  -->
                                            <button class="share-btn btn-xss btn dropdown-toggle gig-navigation active"
                                                id="gig-navigation-title_C"> 설명13</button>
													...
													<form action="detailBuy"  method="post" class="tab-content">
														...
														<c:forEach var="vo" items="${m_boardVO}" varStatus="status">
															...
															<div id="menu${status.count}" class="tab-pane fade">
																...
																<div class="package-header">
																	<h3>${vo.m_year1}년${vo.m_month1}월~${vo.m_year2}년${vo.m_month2}월 </h3>
																</div>
																	...
																	<div class="GigPackageOption">
																		<select id="time-select" name="rno">
																			...
																			<c:forEach var="bo" items="${m_boardVO}" varStatus="option">
																				<option value="${bo.rno}" >
																					<h2>요일 : ${bo.m_day} /${bo.m_time1}시 ~ ${bo.m_time2}시 까지 ${bo.rno} 번 </h2>
								...
								<div class="RightButtomModules">
									<ul class="hostInfo">
										...
										<li class="host_mail"><span class="host_info_title">이메일</span> <span> : </span>
											<span
												class="host_info_txt">${usersVO.userEmail1} @ ${usersVO.userEmail2}</span>
										</li>

										<li class="host_phone"><span class="host_info_title">전화번호</span> <span> :
											</span> <span class="host_info_txt">${usersVO.userPhoneNumber}</span></li>
										<li class="host_intro">
						...
						<div class="col-sm-12 write-wrap">
							...
							<div id="replyList">
								<div class='reply-wrap'>
									...
									<div class='reply-content'>
										<div class='reply-group'>
											<strong class='left'>honggildong</strong> <small
												class='left'>2019/12/10</small> <a href='#' class='right'><span
							...
							<button type="button" class="btn btn-default btn-block" id="moreList"
								style="background-color: red">더보기</button>
						</div>
					</div>
				</div>
			</section>
