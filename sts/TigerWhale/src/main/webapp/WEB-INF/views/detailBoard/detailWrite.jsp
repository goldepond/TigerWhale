		...
		<div class="row">
			<div class="col-sm-12 write-wrap">
				...
				<form action="freeUpdate">
					...
					<div class="form-group">
						<label>제목</label> <input class="form-control" name='title' value="${vo.title }" required>
					</div>
					<div class="form-group">
						<label>이미지 선택</label> <input class="form-control" name='bno' value="${vo.bno }" readonly>
					</div>
					<div class="form-group">
						<label>대표 금액</label> <input class="form-control" name='bno' value="${vo.bno }">
					</div>
					...
					<div class="option">
						...
						<div class="form-group">
							<label>금액</label> <input class="form-control" name='bno' value="${vo.bno }">
						</div>

						<div class="form-group">
							<label>날짜</label> <input class="form-control" name='bno' value="${vo.bno }">
						</div>
					...
					<button type="button" class="right btn btn-default btn_option" id="replyRegist">옵션 추가하기</button>
...
<script>
	...
	function goPopup() {
		...
		var pop = window.open(
				"/publishing/TestWeb/resources/js/pop/jusoPopup.jsp", "pop",
