            ...
            <div class="main-searchpage">
                ...
                <div class="main-board-searchpage">
                    ...
                    <section class="css-1wyl56j">
                        ...
                        <a href="/" class="css-mz86x3 e1rp7ga00">í</a>
                        <div class="css-1hdh32i e1rp7ga01">&gt;</div>
                        <a href="/category/6" class="css-mz86x3 e1rp7ga00">ITÂ·íë¡ê·¸ëë°</a>
                        <div class="css-1hdh32i e1rp7ga01">&gt;</div>
                        <a href="/category/603" class="css-mz86x3 e1rp7ga00">ìëíë ì¤</a>
                    </section>
                    <!-- ë©í ë©í° ì²´í¬ -->
                                ...
                                <div class="css-0 e1t4yfrj1">
                                    <label color="#ffd400" class="css-2k98vs">
                                        <span class="css-19ldx4e">
                                            ...
                                            <span class="css-1wreaqz elgfge1">ë©í </span>
                                        </span>
                                    </label>
                                </div>
                                <div class="css-0 e1t4yfrj1">
                                ...
                                <div data-testid="GigCard" class="css-1d3w5wq ezeyqpv18">
                                    <a href="/gig/79053" class="css-1mr8hr4 ezeyqpv17">
                                            ...
                                            <div class="css-1tgcat7 exlplif3">
                                                <div class="css-1lfj0cb exlplif2">
                                                    <div tabindex="0" data-testid="carousel-item-0" class="css-1ohlt9r exlplif0">
                                                        <img title="ì§ì í ë°ìí + ëª¨ë°ì¼ ì ìí ì¹ íë¦¬í°ë¥¼ ë³´ì¬ ëë¦½ëë¤."
                                                             alt="ì§ì í ë°ìí + ëª¨ë°ì¼ ì ìí ì¹ íë¦¬í°ë¥¼ ë³´ì¬ ëë¦½ëë¤."
                                        ...
                                        <div class="css-gxq4i8 ezeyqpv13">
                                            <h3 data-testid="title" class="css-abfrks ezeyqpv9">ì§ì í ë°ìí + ëª¨ë°ì¼ ì ìí ì¹ íë¦¬í°ë¥¼ ë³´ì¬ ëë¦½ëë¤.</h3>
                                            <div class="css-1eoy87d ezeyqpv6">
                                                <div class="css-s5xdrg ezeyqpv5">
                                                    <div data-testid="price" class="css-1848xfl ezeyqpv4">
                                                        <span>750,000</span><strong>ì~</strong></div>
                                                </div>
                                            </div>
                                            <div class="css-mkpab3 ezeyqpv2"><span role="img" rotate="0" data-testid="rating-icon"
                                                    ...
                                                    </svg></span>5.0<span class="css-p9bq5v ezeyqpv0"></span>
                                                <div class="css-0 ezeyqpv1">86ê°ì íê°</div>
                                            </div>
                                        </div>
                                    </a></div>
                            </article>
                            <article class="css-1c4kgrp elz42uf4">
                                <div data-testid="GigCard" class="css-1d3w5wq ezeyqpv18"><a href="/gig/79053" class="css-1mr8hr4 ezeyqpv17">
                                        <div class="css-7ie1j7 ezeyqpv16">
                                            <div class="css-1tgcat7 exlplif3">
                                                <div class="css-1lfj0cb exlplif2">
                                                    <div tabindex="0" data-testid="carousel-item-0" class="css-1ohlt9r exlplif0">
                                                        <img title="ê³ ê°ì´ ìíìë ë§ì¶¤ì¬ìì¼ë¡ ë°ìí ì¹ì¬ì´í¸ë¥¼ êµ¬ì¶í´ ëë¦½ëë¤."
                                                             alt="ê³ ê°ì´ ìíìë ë§ì¶¤ì¬ìì¼ë¡ ë°ìí ì¹ì¬ì´í¸ë¥¼ êµ¬ì¶í´ ëë¦½ëë¤."
                                                             src="https://d2v80xjmx68n4w.cloudfront.net/gigs/EJtrV1602433672.jpg" loading="lazy"
                                                             class="css-d1mg3o ejobblq0">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="css-gxq4i8 ezeyqpv13">
                                            <h3 data-testid="title" class="css-abfrks ezeyqpv9">ê³ ê°ì´ ìíìë ë§ì¶¤ì¬ìì¼ë¡ ë°ìí ì¹ì¬ì´í¸ë¥¼ êµ¬ì¶í´ ëë¦½ëë¤.</h3>
                                            <div class="css-1eoy87d ezeyqpv6">
                                                <div class="css-s5xdrg ezeyqpv5">
                                                    <div data-testid="price" class="css-1848xfl ezeyqpv4">
                                                        <span>50,000</span><strong>ì~</strong></div>
                                                </div>
                                            </div>
                                            <div class="css-mkpab3 ezeyqpv2"><span role="img" rotate="0" data-testid="rating-icon"
                                                    class="ezeyqpv3 css-1mrr0sj e181xm9y1"><svg width="18" height="18" viewBox="0 0 24 24"
                                                    ...
                                                    </svg></span>4.0<span class="css-p9bq5v ezeyqpv0"></span>
                                                <div class="css-0 ezeyqpv1">3ê°ì íê°</div>
                                            </div>
                                        </div>
                                    </a></div>
                            </article>
